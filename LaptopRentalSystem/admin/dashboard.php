            ...
            <main class="content px-3 py-2">
                ...
                <section>
                    <div class="container-fluid content">
                        <p>Welcome to the Laptop Rental Management System.
                            Here, you can manage all aspects of the business efficiently.
                            Here are some of the tasks you can perform:
                        </p>
                        <ul>
                            <li><strong>Monitor Inventory:</strong>
                                <p>Update inventory status.</p>
                            </li>
                            <li><strong>Manage Orders:</strong>
                                <p>View current and past orders, approve or reject rental requests, and handle returns.</p>
                            </li>
                            <li><strong>User Management:</strong>
                                <p>Oversee customer accounts, review feedback, and manage user privileges.</p>
                            </li>
                        </ul>
                    </div>
