    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="content px-3 py-2">
                ...
                <!-- Laptop management card -->
                <div class="row">
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <img src="../images/pM.jpg" class="img-fluid l-img" alt="">
                            </div>
                            <button class="btn btn-outline-success">
                                <a href="insertProduct.php" class="btn-link">Insert New Product</a>
                            </button>
                        </div>
                    </div>
                    <div class="col-sm-12 col-md-6 col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <img src="../images/pM1.png" class="img-fluid l-img" alt="">
                            </div>
                            <button class="btn btn-outline-info">
                                <a href="editProduct.php" class="btn-link">Edit Product</a>
                            </button>
                        </div>
                    </div>
                </div>
